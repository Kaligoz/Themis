...
export function CurrencySelect({ defaultValue = "USD", name = "currency" }: CurrencySelectProps) {
  return (
    <Select name={name} defaultValue={defaultValue}>
      <SelectTrigger className="w-full bg-[rgb(var(--secondary))] border-none dark:bg-[rgb(var(--secondary))] dark:hover:bg-[rgb(var(--secondary))] hover:cursor-pointer md:text-base text-sm">
