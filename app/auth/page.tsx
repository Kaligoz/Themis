    ...
    return (
        <main className="grid grid-cols-2 grid-rows-1">
            <section className="relative bg-[rgb(var(--accent))] shadow-[15px_0px_30px_20px_rgba(0,_0,_0,_0.1)] h-screen overflow-hidden">
                <h1 className="absolute top-0 left-0 text-[rgb(var(--primary))] text-[310px] font-bold origin-top-left rotate-90 whitespace-nowrap leading-none tracking-tighter translate-x-[275px]">
                    THEMIS
                </h1>
            </section>
